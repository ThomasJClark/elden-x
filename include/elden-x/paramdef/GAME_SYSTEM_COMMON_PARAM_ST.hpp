...
struct GAME_SYSTEM_COMMON_PARAM_ST
{
     ...
     */
    float stealthSystemSightRate_NotInStealthRigid_NotSightHide_StealthMode{1.f};

    /**
     * @brief Stealth visibility magnification_Standing in stealth ray shielded
     * area
     */
    float stealthSystemSightRate_NotInStealthRigid_SightHide_NotStealthMode{1.f};
     ...
     */
    float stealthSystemSightRate_InStealthRigid_NotSightHide_NotStealthMode{1.f};
     ...
     * effect
     */
    float stealthSystemSightAngleReduceRate_NotInStealthRigid_NotSightHide_StealthMode{0.f};

    /**
     * @brief Stealth view angle attenuation rate_Standing in stealth ray
     * shielded area
     */
    float stealthSystemSightAngleReduceRate_NotInStealthRigid_SightHide_NotStealthMode{0.f};

    /**
     * @brief Stealth visibility angle attenuation _ crouching in stealth ray
     * shielded area
     */
    float stealthSystemSightAngleReduceRate_NotInStealthRigid_SightHide_StealthMode{0.f};

    /**
     * @brief Stealth view angle attenuation rate_Standing within stealth hit
     */
    float stealthSystemSightAngleReduceRate_InStealthRigid_NotSightHide_NotStealthMode{0.f};
     ...
     */
    float stealthSystemSightAngleReduceRate_InStealthRigid_NotSightHide_StealthMode{0.f};

    /**
     * @brief Stealth view angle attenuation rate_Stealth ray shielded area +
     * standing in stealth hit
     */
    float stealthSystemSightAngleReduceRate_InStealthRigid_SightHide_NotStealthMode{0.f};

    /**
     * @brief Stealth view angle attenuation rate_Stealth ray shielded area +
     * crouching in stealth hit
     */
    float stealthSystemSightAngleReduceRate_InStealthRigid_SightHide_StealthMode{0.f};
